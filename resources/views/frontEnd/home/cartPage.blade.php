...
<!-- Mirrored from www.themesground.com/flipmart-demo/HTML/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Apr 2018 06:11:29 GMT -->
<head>
		<!-- Meta -->
		<meta charset="utf-8">
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="detail.html"><img src="{{ asset('frontEnd') }}/images/cart.jpg" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
    ...
    <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
             ...
             <a href="#"><img alt="" src="{{ asset('frontEnd') }}/images/banners/banner-side.png"></a>
             </div>
    </div><!-- /.row -->
</div><!-- /.yamm-content -->					</li>
				</ul>
