...
<!-- Mirrored from thememakker.com/templates/oreo/html/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Mar 2018 23:29:41 GMT -->
<head>
<meta charset="utf-8">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                @csrf
                    ...
                    <div class="footer text-center">
                        <button type="submit"
                            href="index-2.html" class="btn btn-primary btn-round btn-lg btn-block waves-effect waves-light">{{ __('Reset Password') }}</a>
                        </button>
                    </div>
