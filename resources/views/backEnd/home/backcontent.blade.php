...
<!-- Backend Title Update -->
@section('title_back_area')
        Laravel Backend | Ecommerce Web App
@endsection


<!-- Backend Content Extends Here  -->
            ...
            <div class="col-sm-8">
             ...
             <div class="row">
                <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                    <div class="blogThumb">
                        <div class="thumb-center"><img class="img-responsive" alt="user" src="{{ asset('backend') }}/img/course/course1.jpg"></div>
                ...
                <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                    <div class="blogThumb">
                        <div class="thumb-center"><img class="img-responsive" alt="user" src="{{ asset('backend') }}/img/course/course2.jpg"></div>
                        <div class="course-box">
                        <h4>PHP Development Course</h4>
                            <div class="text-muted"><span class="m-r-10">April 23</span>
                                <a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
                ...
                <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                    <div class="blogThumb">
                        <div class="thumb-center"><img class="img-responsive" alt="user" src="{{ asset('backend') }}/img/course/course3.jpg"></div>
                        <div class="course-box">
                        <h4>PHP Development Course</h4>
                            <div class="text-muted"><span class="m-r-10">April 23</span>
                                <a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
                ...
                <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                    <div class="blogThumb">
                        <div class="thumb-center"><img class="img-responsive" alt="user" src="{{ asset('backend') }}/img/course/course4.jpg"></div>
                        <div class="course-box">
                        <h4>PHP Development Course</h4>
                            <div class="text-muted"><span class="m-r-10">April 23</span>
                                <a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
                            ...
                            <ul class="feed-blog">
                                <li class="active-feed">
                                    <div class="feed-user-img">
                                        <img src="{{ asset('backend') }}/img/std/std1.jpg" class="img-radius "
                                    ...
                                    <div class="row">
                                        <div class="col-auto text-center">
                                            <img src="{{ asset('backend') }}/img/mega-img1.jpg" alt="img"
                                        ...
                                        <div class="col-auto text-center">
                                            <img src="{{ asset('backend') }}/img/mega-img3.jpg" alt="img"
                                                class="img-fluid img-100">
                                        ...
                                        <div class="col-auto text-center">
                                            <img src="{{ asset('backend') }}/img/mega-img2.jpg" alt="img"
                                                class="img-fluid img-100">
                                ...
                                <li class="diactive-feed">
                                    <div class="feed-user-img">
                                        <img src="{{ asset('backend') }}/img/std/std2.jpg" class="img-radius "
                                            alt="User-Profile-Image">
                                    </div>
                                    <h6>
                                ...
                                <li class="diactive-feed">
                                    <div class="feed-user-img">
                                        <img src="{{ asset('backend') }}/img/std/std3.jpg" class="img-radius "
                                            alt="User-Profile-Image">
                                    </div>
                                    <h6>
                                ...
                                <li class="active-feed">
                                    <div class="feed-user-img">
                                        <img src="{{ asset('backend') }}/img/std/std4.jpg" class="img-radius "
                                            alt="User-Profile-Image">
                                    </div>
                                    <h6>
